        ...
        <div className="min-h-screen bg-[#0a0a0c] text-slate-300 py-12 lg:py-20 px-6">
            <article className="max-w-3xl mx-auto">
                ...
                <footer className="mt-24 p-12 bg-white/5 rounded-2xl border border-slate-800 text-center">
                    ...
                    <Link href="/series/99-archive/modern-fullstack-roadmap" className="inline-block bg-emerald-600 hover:bg-emerald-500 text-white font-bold py-3 px-8 rounded-full transition-all hover:scale-105 active:scale-95">
                        Modern 編の最終章を読む
                    </Link>
                </footer>
            </article>
