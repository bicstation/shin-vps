...
RESULT1=$(docker compose exec -T django-v3 python manage.py linkshare_bc_api_parser \
...
RESULT2=$(docker compose exec -T django-v3 python manage.py linkshare_bc_api_parser \
...
RESULT3=$(docker compose exec -T django-v3 python manage.py linkshare_bc_api_parser \
...
RESULT4=$(docker compose exec -T django-v3 python manage.py linkshare_bc_api_parser \
