...
==============================================================================
FILE:
    acquisition/sources/scraping/dynabook/acquire_listing.py

SHIN CORE LINX

dynabook / FMV Manufacturer Reality Acquire Runtime
...
URL Resolver Runtime
        │
        ▼
dynabook / FMV Official Product URL
        │
        ▼
HTTP Acquisition
        │
...
- Acquire dynabook / FMV Manufacturer HTML
- Resolve dynabook / FMV official URL
- Preserve raw HTML
...
dynabook / FMV does NOT use the normal
seed.tsv → listing page model.

The Runtime receives existing PCProduct records through
discover_seed.py.

The dynabook / FMV affiliate URL is resolved by:

    url_resolver.py

The resulting dynabook / FMV official URL is then acquired directly.
...
def acquire_http(
    *,
    ...
    """
    Acquire one dynabook / FMV Manufacturer page.
...
def save_document(
    *,
    ...
    """
    Persist dynabook / FMV Manufacturer Reality.
...
def get_cached_document(
    *,
    ...
    """
    Return cached dynabook / FMV Manufacturer
    AcquisitionDocument.
    """
...
def acquire_product(
    *,
    ...
    """
    Acquire one dynabook / FMV Manufacturer Reality target.
...
def acquire(
    *,
    ...
    """
    Execute dynabook / FMV Manufacturer Reality
    Acquisition Runtime.

    Target:

        All existing dynabook PCProduct records.
    ...
    print(
        "🌐 dynabook / FMV MANUFACTURER REALITY ACQUIRE"
    )
    ...
    print(
        "dynabook / FMV MANUFACTURER REALITY ACQUIRE RESULT"
    )
