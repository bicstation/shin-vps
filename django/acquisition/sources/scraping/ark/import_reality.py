# /home/maya/shin-vps/django/acquisition/sources/scraping/ark/import_reality.py
#!/usr/bin/env python3
"""
==============================================================================
SHIN CORE LINX

ARK Reality Import Runtime
...
def import_reality(
    ...
    print(f"📥 {SITE_NAME.upper()} REALITY IMPORT")

    print("=" * 70)

    if not REALITY_DIR.exists():

        print("Reality Directory Not Found")
    ...
    for file in files:
        ...
        _, created = AcquisitionDocument.objects.update_or_create(
