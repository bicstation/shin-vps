...
export default function BrokerGuidePage() {
  return (
    ...
    <div>
      ...
      <img border="0" width="250" height="250" alt="" src="https://www26.a8.net/svt/bgt?aid=150718133961&wid=095&eno=01&mid=s00000008903001083000&mc=1"></a>
      <img border="0" width="1" height="1" src="https://www14.a8.net/0.gif?a8mat=2HQEUT+FW7LNM+1WP2+6G4HD" alt=""></img>
    </div>
  );
}