...
# C-PLAN: SUPREME FLEET COMMANDER - v4.5.2 (Marya Fix Edition)
# ------------------------------------------------------------------------------
...
# 💡 修正ポイント: 名前が Marya であっても、ディレクトリが存在すれば本番環境とみなす
...
# 7. 💥 出撃シークエンス開始
{
    ...
    for PRJ in "${PROJECTS[@]}"; do
        ...
        # 🛠️ 修正ポイント: 一部のDocker環境でエラーになる -T フラグを削除して安定化
