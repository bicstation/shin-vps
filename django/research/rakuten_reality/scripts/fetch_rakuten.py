...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--shop", dest="shop_code", type=str, default=None, help="Rakuten shop code")
    parser.add_argument("--item", dest="item_code", type=str, default=None, help="Rakuten item code")
    parser.add_argument("--genre", dest="genre_id", type=str, default=None, help="Rakuten genre ID")
    parser.add_argument("--page", type=int, default=1, help="Page number")
    parser.add_argument("--hits", type=int, default=30, help="Number of items per page")
