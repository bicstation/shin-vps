...
export async function generateMetadata(props: { params: Promise<{ id: string }> }): Promise<Metadata> {
  ...
  try {
    ...
    const title = `${product.title || '詳細'} | ${actressNames ? `${actressNames}出演 | ` : ''}tiper.live`;
              ...
              <div className="bg-[#0a0a1a] p-8 rounded-[1px] relative overflow-hidden">
                ...
                <div className="flex justify-between items-start mb-8 relative z-10">
                  <div>
                    ...
                    <h3 className="text-2xl font-black text-white italic tracking-tighter leading-none">アーカイブの全データを閲覧する</h3>
                  </div>
                </div>
