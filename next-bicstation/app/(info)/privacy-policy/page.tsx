...
export const metadata = {
  title: 'プライバシーポリシー・免責事項・広告掲載について | BICSTATION',
  description: 'BICSTATION（ビックステーション）の個人情報保護、API利用規約、Amazonアソシエイト等のアフィリエイト広告に関する詳細情報。',
};
  ...
  return (
    ...
    >
      ...
      <section id="disclaimer">
        ...
        <p>
          特にPC自作、ファームウェアのアップデート、周辺機器の互換性に関する情報は、環境によって結果が大きく異なる場合があります。情報のご利用にあたっては、メーカーの公式マニュアルを併読の上、ご自身の判断と責任において行っていただきますようお願い申し上げます。
        </p>
      </section>
