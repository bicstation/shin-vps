...
==============================================================================
FILE:
    acquisition/sources/scraping/hp/acquire_listing.py

SHIN CORE LINX

HP Manufacturer Reality Acquire Runtime
...
- Acquire HP Manufacturer HTML
- Resolve HP official URL
- Preserve raw HTML
...
HP does NOT use the normal seed.tsv → listing page model.

The Runtime receives existing PCProduct records through
discover_seed.py.

The HP affiliate URL is resolved by:

    url_resolver.py

The resulting HP official URL is then acquired directly.
...
def acquire_http(
    *,
    ...
    """
    Acquire one HP Manufacturer page.
...
def save_document(
    *,
    ...
    """
    Persist HP Manufacturer Reality.
...
def get_cached_document(
    *,
    ...
    """
    Return cached HP Manufacturer AcquisitionDocument.
    """
...
def acquire_product(
    *,
    ...
    """
    Acquire one HP Manufacturer Reality target.
...
def acquire(
    *,
    ...
    """
    Execute HP Manufacturer Reality Acquisition Runtime.

    Target:

        All existing HP PCProduct records.
    ...
    print(
        "🌐 HP MANUFACTURER REALITY ACQUIRE"
    )
    ...
    print(
        "HP MANUFACTURER REALITY ACQUIRE RESULT"
    )
