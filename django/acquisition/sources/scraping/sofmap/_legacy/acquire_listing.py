...
==============================================================================
FILE:
    acquisition/sources/scraping/dell/acquire_listing.py

SHIN CORE LINX

DELL Manufacturer Reality Acquire Runtime
...
- Acquire DELL Manufacturer HTML
- Resolve DELL official URL
- Preserve raw HTML
...
DELL does NOT use the normal seed.tsv → listing page model.

The Runtime receives existing PCProduct records through
discover_seed.py.

The DELL affiliate URL is resolved by:

    url_resolver.py

The resulting DELL official URL is then acquired directly.
...
def acquire_http(
    *,
    ...
    """
    Acquire one DELL Manufacturer page.
...
def save_document(
    *,
    ...
    """
    Persist DELL Manufacturer Reality.

    Django ORM is intentionally isolated from HTTP acquisition.
    """

    document_key = (
        f"product__{product.unique_id}"
    )
...
def get_cached_document(
    *,
    ...
    """
    Return cached DELL Manufacturer AcquisitionDocument.
    """
...
def acquire_product(
    *,
    ...
    """
    Acquire one DELL Manufacturer Reality target.
...
def acquire(
    *,
    ...
    """
    Execute DELL Manufacturer Reality Acquisition Runtime.

    Target:

        All existing DELL PCProduct records.
    ...
    print(
        "🌐 DELL MANUFACTURER REALITY ACQUIRE"
    )
    ...
    print(
        "DELL MANUFACTURER REALITY ACQUIRE RESULT"
    )
