...
#
# FILE:
# acquisition/sources/scraping/dynabook/verify.py
#
# SHIN CORE LINX
#
# dynabook PCProduct Verification Runtime
#
# Reality First
#
# Responsibilities
#
# - Read saved dynabook PCProducts
# - Verify dynabook PCProduct identity
# - Verify Observation Runtime persistence
# - Display ALL PCProduct columns
# - Verify actual database state
# - Report dynabook PCProduct count
#
...
def get_dynabook_products():
    """
    Return existing dynabook PCProducts.

    Verification reads the database only.

    dynabook identity is verified by:

        maker == "dynabook"

    AND

        unique_id starts with "dynabook_"
    """
...
def verify():
    """
    Verify actual dynabook PCProduct database state.
    ...
    print(
        "dynabook PCPRODUCT VERIFICATION"
    )
    ...
    products = get_dynabook_products()
